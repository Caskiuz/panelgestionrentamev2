...
function Overview() {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        try {
          ...
          allServices = serviciosData.response || [];
        } catch (e) {
          allServices = [];
        }
        // Clientes
        ...
        // Pagos de servicios para hoy (servicios no pagados que vencen hoy)
        ...
        // Pagos atrasados (servicios no pagados y vencidos)
  ...
  return (
    <div className="flex h-screen bg-gray-100 font-sans">
      <CobroGestSidebar />
      <main className="flex-1 p-2 md:p-8 overflow-y-auto bg-gray-100">
        <header className="flex flex-col md:flex-row justify-between items-center bg-white p-4 md:p-6 rounded-xl shadow-md mb-8 gap-4">
